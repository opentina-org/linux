...
static SUNXI_CCU_MP_DATA_WITH_MUX_GATE_FEAT(nsi_clk, "nsi",
		...
		24, 3,	/* mux */
		BIT(31),	/* gate */
		CLK_SET_RATE_NO_REPARENT | CLK_GET_RATE_NOCACHE | CLK_IS_CRITICAL,
		CCU_FEATURE_UPDATE_BIT);

static SUNXI_CCU_GATE(nsi_cfg_clk, "nsi-cfg",
		"apb0",
		0x0584, BIT(0), CLK_IS_CRITICAL);
...
static SUNXI_CCU_GATE(msi_lite0_clk, "msi-lite0",
		"ahb",
		0x0594, BIT(0), CLK_IS_CRITICAL);

static SUNXI_CCU_GATE(msi_lite1_clk, "msi-lite1",
		"ahb",
		0x059C, BIT(0), CLK_IS_CRITICAL);
...
static SUNXI_CCU_GATE(iommu1_sys_mbus_clk, "iommu1-sys-mclk",
		"mbus",
		0x05B4, BIT(0), CLK_IGNORE_UNUSED);
...
static SUNXI_CCU_MP_DATA_WITH_MUX_GATE_FEAT(dram0_clk, "dram0",
		...
		24, 3,	/* mux */
		BIT(31),	/* gate */
		CLK_SET_RATE_PARENT | CLK_IS_CRITICAL | CLK_GET_RATE_NOCACHE,
		CCU_FEATURE_UPDATE_BIT);
...
static SUNXI_CCU_DUALDIV_MUX_GATE(smhc1_clk, "smhc1",
		smhc_parents, 0x0D10,
		0, 5,	/* M */
		8, 5,	/* N */
		24, 3,	/* mux */
...
static SUNXI_CCU_DUALDIV_MUX_GATE(smhc3_clk, "smhc3",
...
static SUNXI_CCU_DUALDIV_MUX_GATE(spi1_clk, "spi1",
		spi_parents, 0x0F08,
		0, 5,	/* M */
		8, 5,	/* N */
		24, 3,	/* mux */
...
static SUNXI_CCU_DUALDIV_MUX_GATE(spi2_clk, "spi2",
		spi_parents, 0x0F10,
		0, 5,	/* M */
		8, 5,	/* N */
		24, 3,	/* mux */
...
static SUNXI_CCU_DUALDIV_MUX_GATE(spi3_clk, "spi3",
		spi_parents, 0x0F20,
		0, 5,	/* M */
		8, 5,	/* N */
		24, 3,	/* mux */
...
static SUNXI_CCU_DUALDIV_MUX_GATE(spi4_clk, "spi4",
		spi_parents, 0x0F28,
		0, 5,	/* M */
		8, 5,	/* N */
		24, 3,	/* mux */
...
static SUNXI_CCU_DUALDIV_MUX_GATE(csi_master1_clk, "csi-master1",
...
static SUNXI_CCU_DUALDIV_MUX_GATE(csi_master2_clk, "csi-master2",
...
static int sun60iw2_ccu_really_probe(struct platform_device *pdev)
{
	void __iomem *reg;
	int ret, i;
	u32 val;
	...
	val = readl(reg + SUN60IW2_PLL_AUDIO0_PATTERN1_REG);
	val |= PLL_AUDIO0_PAT1_PI_EN | PLL_AUDIO0_PAT1_SDM_EN;
	writel(val, reg + SUN60IW2_PLL_AUDIO0_PATTERN1_REG);
...
{
	return sun60iw2_ccu_really_probe(pdev);
}
