...
static int __init sunxi_nsi_driver_init(void)
{
	return nsi_pmu_init();
}

module_init(sunxi_nsi_driver_init);
module_exit(nsi_pmu_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Allwinner NSI interconnect support");
MODULE_AUTHOR("Allwinner Technology Co.,Ltd.");
MODULE_VERSION("1.1.2");
MODULE_ALIAS("platform:allwinner,sunxi-nsi");
