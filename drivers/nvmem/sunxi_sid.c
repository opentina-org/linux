...
static const struct sunxi_sid_cfg sun60iw2_sid_cfg = {
	.value_offset = 0x200,
	.size = 0x300,
};
...
static const struct of_device_id sunxi_sid_of_match[] = {
	...
	{ .compatible = "allwinner,sunxi-sid", .data = &sun60iw2_sid_cfg },
	{ .compatible = "allwinner,sun60iw2-sid", .data = &sun60iw2_sid_cfg },
	{/* sentinel */},
};
