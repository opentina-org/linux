...
#define CSIC_ISP1_BRIDGE_CH_EN_DISABLE		21
#define CSIC_ISP1_BRIDGE_CH_EN_DISABLE_MASK	(0X1 << CSIC_ISP1_BRIDGE_CH_EN_DISABLE)
#define CSIC_ISP1_F2S1_BRIDGE_CH_EN		22
#define CSIC_ISP1_F2S1_BRIDGE_CH_EN_MASK	(0X1 << CSIC_ISP1_F2S1_BRIDGE_CH_EN)
#define CSIC_ISP1_S1F2_BRIDGE_CH_EN		26
#define CSIC_ISP1_S1F2_BRIDGE_CH_EN_MASK	(0X1 << CSIC_ISP1_S1F2_BRIDGE_CH_EN)
...
#define CSIC_DMA0_IN_REG_OFF			0X0D0
#define CSIC_DMA1_IN_REG_OFF			0X0D4
#define CSIC_DMA2_IN_REG_OFF			0X0D8
#define CSIC_DMA3_IN_REG_OFF			0X0DC
...
#define CSIC_MULP_DONE_EN			0
#define CSIC_MULP_DONE_EN_MASK			(0X1 << CSIC_MULP_DONE_EN)
#define CSIC_MULP_ERR_EN			1
#define CSIC_MULP_ERR_EN_MASK			(0X1 << CSIC_MULP_ERR_EN)
...
#define CSIC_SRC_MSK_BK2_CH1			25
#define CSIC_SRC_MSK_BK2_CH1_MASK		(0X1 << CSIC_SRC_MSK_BK2_CH1)
#define CSIC_SRC_MSK_BK2_CH2			26
#define CSIC_SRC_MSK_BK2_CH2_MASK		(0X1 << CSIC_SRC_MSK_BK2_CH2)
#define CSIC_SRC_MSK_BK2_CH3			27
#define CSIC_SRC_MSK_BK2_CH3_MASK		(0X1 << CSIC_SRC_MSK_BK2_CH3)
#define CSIC_SRC_MSK_BK3_CH0			28
#define CSIC_SRC_MSK_BK3_CH0_MASK		(0X1 << CSIC_SRC_MSK_BK3_CH0)
#define CSIC_SRC_MSK_BK3_CH1			29
#define CSIC_SRC_MSK_BK3_CH1_MASK		(0X1 << CSIC_SRC_MSK_BK3_CH1)
#define CSIC_SRC_MSK_BK3_CH2			30
#define CSIC_SRC_MSK_BK3_CH2_MASK		(0X1 << CSIC_SRC_MSK_BK3_CH2)
#define CSIC_SRC_MSK_BK3_CH3			31
#define CSIC_SRC_MSK_BK3_CH3_MASK		(0X1 << CSIC_SRC_MSK_BK3_CH3)
...
#define CSIC_BK2_CH1_INT_LOST_INT_EN		25
#define CSIC_BK2_CH1_INT_LOST_INT_EN_MASK	(0X1 << CSIC_BK2_CH1_INT_LOST_INT_EN)
#define CSIC_BK2_CH2_INT_LOST_INT_EN		26
#define CSIC_BK2_CH2_INT_LOST_INT_EN_MASK	(0X1 << CSIC_BK2_CH2_INT_LOST_INT_EN)
#define CSIC_BK2_CH3_INT_LOST_INT_EN		27
#define CSIC_BK2_CH3_INT_LOST_INT_EN_MASK	(0X1 << CSIC_BK2_CH3_INT_LOST_INT_EN)
#define CSIC_BK3_CH0_INT_LOST_INT_EN		28
#define CSIC_BK3_CH0_INT_LOST_INT_EN_MASK	(0X1 << CSIC_BK3_CH0_INT_LOST_INT_EN)
#define CSIC_BK3_CH1_INT_LOST_INT_EN		29
#define CSIC_BK3_CH1_INT_LOST_INT_EN_MASK	(0X1 << CSIC_BK3_CH1_INT_LOST_INT_EN)
#define CSIC_BK3_CH2_INT_LOST_INT_EN		30
#define CSIC_BK3_CH2_INT_LOST_INT_EN_MASK	(0X1 << CSIC_BK3_CH2_INT_LOST_INT_EN)
#define CSIC_BK3_CH3_INT_LOST_INT_EN		31
#define CSIC_BK3_CH3_INT_LOST_INT_EN_MASK	(0X1 << CSIC_BK3_CH3_INT_LOST_INT_EN)
...
#define BK2_CH1_INT_LOST_INT_PD		25
#define BK2_CH1_INT_LOST_INT_PD_MASK	(0X1 << BK2_CH1_INT_LOST_INT_PD)
#define BK2_CH2_INT_LOST_INT_PD		26
#define BK2_CH2_INT_LOST_INT_PD_MASK	(0X1 << BK2_CH2_INT_LOST_INT_PD)
#define BK2_CH3_INT_LOST_INT_PD		27
#define BK2_CH3_INT_LOST_INT_PD_MASK	(0X1 << BK2_CH3_INT_LOST_INT_PD)
#define BK3_CH0_INT_LOST_INT_PD		28
#define BK3_CH0_INT_LOST_INT_PD_MASK	(0X1 << BK3_CH0_INT_LOST_INT_PD)
#define BK3_CH1_INT_LOST_INT_PD		29
#define BK3_CH1_INT_LOST_INT_PD_MASK	(0X1 << BK3_CH1_INT_LOST_INT_PD)
#define BK3_CH2_INT_LOST_INT_PD		30
#define BK3_CH2_INT_LOST_INT_PD_MASK	(0X1 << BK3_CH2_INT_LOST_INT_PD)
#define BK3_CH3_INT_LOST_INT_PD		31
#define BK3_CH3_INT_LOST_INT_PD_MASK	(0X1 << BK3_CH3_INT_LOST_INT_PD)
...
#define CSIC_MCSI_HCLK_AUTOGATE_CYCLE 		20
#define CSIC_MCSI_HCLK_AUTOGATE_CYCLE_MASK	(0XF << CSIC_MCSI_HCLK_AUTOGATE_CYCLE)
#define CSIC_MCSI_HCLK_AUTOGATE_EN 		27
#define CSIC_MCSI_HCLK_AUTOGATE_EN_MASK		(0X1 << CSIC_MCSI_HCLK_AUTOGATE_EN)
...
#define CSIC_MISP1_BRIDGE_CLK_EN		5
#define CSIC_MISP1_BRIDGE_CLK_EN_MASK   	(0X1 << CSIC_MISP1_BRIDGE_CLK_EN)
...
#define CSIC_MISP1_BRIDGE_CH_CLK_GATING_DISABLE      21
#define CSIC_MISP1_BRIDGE_CH_CLK_GATING_DISABLE_MASK   	(0X1 << CSIC_MISP1_BRIDGE_CH_CLK_GATING_DISABLE)
#define CSIC_MISP1_F2S1_BRIDGE_CH_CLK_EN			22
#define CSIC_MISP1_F2S1_BRIDGE_CH_CLK_EN_MASK  		(0X1 << CSIC_MISP1_F2S1_BRIDGE_CH_CLK_EN)
#define CSIC_MISP1_S2F1_BRIDGE_CH_CLK_EN		    26
#define CSIC_MISP1_S2F1_BRIDGE_CH_CLK_EN_MASK   	(0X1 << CSIC_MISP1_S2F1_BRIDGE_CH_CLK_EN)
