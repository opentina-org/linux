 ...
 */
static void cmb_phy_reset_assert(void)
{
...
static void cmb_phy_reset_deassert(void)
{
	vin_reg_clr_set(cmb_csi_top_base_addr + CMB_PHY_TOP_REG_OFF,
...
static void cmb_phy_power_enable(void)
{
	vin_reg_clr_set(cmb_csi_top_base_addr + CMB_PHY_TOP_REG_OFF,
...
static void cmb_phy_power_disable(void)
{
	vin_reg_clr_set(cmb_csi_top_base_addr + CMB_PHY_TOP_REG_OFF,
...
static void cmb_phy_set_vref_0p9(unsigned int step)
{
	vin_reg_clr_set(cmb_csi_top_base_addr + CMB_PHY_TOP_REG_OFF,
		CMB_PHY_VREF_OP9_MASK, step << CMB_PHY_VREF_OP9);
}

static void cmb_phy_set_vref_0p2(unsigned int step)
{
	vin_reg_clr_set(cmb_csi_top_base_addr + CMB_PHY_TOP_REG_OFF,
		CMB_PHY_VREF_OP2_MASK, step << CMB_PHY_VREF_OP2);
}

static void cmb_phy_set_trescal(unsigned int val)
{
...
static void cmb_phya_trescal_reset_assert(void)
{
	vin_reg_clr_set(cmb_csi_top_base_addr + CMB_TRESCAL_REG_OFF,
		CMB_PHYA_TRESCAL_RESETN_MASK, 0x0 << CMB_PHYA_TRESCAL_RESETN);
}

static void cmb_phya_trescal_reset_deassert(void)
{
	vin_reg_clr_set(cmb_csi_top_base_addr + CMB_TRESCAL_REG_OFF,
...
static void cmb_phy_set_deskew_laned1(unsigned int sel, unsigned int delay)
{
...
static void cmb_phy_set_deskew_laned0(unsigned int sel, unsigned int delay)
{
	vin_reg_clr_set(cmb_csi_phy_base_addr[sel] + CMB_PHY_DESKEW1_OFF,
		CMB_PHY_DESKEW_LANED0_SET_MASK, delay << CMB_PHY_DESKEW_LANED0_SET);
}

static void cmb_phy_set_deskew_laneck0(unsigned int sel, unsigned int delay)
{
	vin_reg_clr_set(cmb_csi_phy_base_addr[sel] + CMB_PHY_DESKEW1_OFF,
...
static void cmb_phy0_term_dly(unsigned int sel, unsigned int dly)
{
	vin_reg_clr_set(cmb_csi_phy_base_addr[sel] + CMB_PHY_TERM_CTL_REG_OFF,
		CMB_PHY0_TERM_EN_DLY_MASK, dly << CMB_PHY0_TERM_EN_DLY);
}

static void cmb_phy_mipi_termnum_en(unsigned int sel, struct phy_lane_cfg phy_lane_cfg)
{
	vin_reg_clr_set(cmb_csi_phy_base_addr[sel] + CMB_PHY_TERM_CTL_REG_OFF,
...
static void cmb_phy0_hs_dly(unsigned int sel, unsigned int dly)
{
	vin_reg_clr_set(cmb_csi_phy_base_addr[sel] + CMB_PHY_HS_CTL_REG_OFF,
		CMB_PHY0_HS_DLY_MASK, dly << CMB_PHY0_HS_DLY);
}

static void cmb_phy_hs_en(unsigned int sel, struct phy_lane_cfg phy_lane_cfg)
{
	vin_reg_clr_set(cmb_csi_phy_base_addr[sel] + CMB_PHY_HS_CTL_REG_OFF,
...
static void cmb_phy_s2p_en(unsigned int sel, struct phy_lane_cfg phy_lane_cfg)
{
...
static void cmb_phy0_s2p_width(unsigned int sel, unsigned int width)
{
	vin_reg_clr_set(cmb_csi_phy_base_addr[sel] + CMB_PHY_S2P_CTL_REG_OFF,
...
static void cmb_phy_mipi_lpnum_en(unsigned int sel, struct phy_lane_cfg phy_lane_cfg)
{
...
static void cmb_phy0_mipilp_dbc_en(unsigned int sel, unsigned int en)
{
	vin_reg_clr_set(cmb_csi_phy_base_addr[sel] + CMB_PHY_MIPIRX_CTL_REG_OFF,
		CMB_PHY0_MIPILP_DBC_EN_MASK, en << CMB_PHY0_MIPILP_DBC_EN);
}

static void cmb_phy0_mipihs_sync_mode(unsigned int sel, unsigned int mode)
{
	vin_reg_clr_set(cmb_csi_phy_base_addr[sel] + CMB_PHY_MIPIRX_CTL_REG_OFF,
...
static void cmb_port_mipi_unpack_enable(unsigned int sel)
{
	vin_reg_clr_set(cmb_csi_port_base_addr[sel] + CMB_PORT_MIPI_CFG_REG_OFF,
		CMB_MIPI_UNPACK_EN_MASK, 1 << CMB_MIPI_UNPACK_EN);
}

static void __maybe_unused cmb_port_mipi_unpack_disable(unsigned int sel)
{
	vin_reg_clr_set(cmb_csi_port_base_addr[sel] + CMB_PORT_MIPI_CFG_REG_OFF,
...
static void cmb_port_mipi_yuv_seq(unsigned int sel, enum cmb_mipi_yuv_seq seq)
{
	vin_reg_clr_set(cmb_csi_port_base_addr[sel] + CMB_PORT_MIPI_CFG_REG_OFF,
...
static void cmb_port_mipi_ph_bitord(unsigned int sel, unsigned int order)
{
	vin_reg_clr_set(cmb_csi_port_base_addr[sel] + CMB_PORT_MIPI_CFG_REG_OFF,
