...
/*
 * A V4L2 driver for gc6153_mipi cameras.
 *
 * Copyright (c) 2022 by Allwinner Technology Co.,Ltd.  http://www.allwinnertech.com
 *
...
MODULE_AUTHOR("lcs");
MODULE_DESCRIPTION("A low-level driver for gc6153 sensors");
MODULE_LICENSE("GPL");
MODULE_VERSION("1.0.0");

#define MCLK              (24 * 1000 * 1000)
#define V4L2_IDENT_SENSOR 0x6153
...
/*
 * The gc6153 i2c address
 */
#define I2C_ADDR 0x80

#define SENSOR_NAME "gc6153"
...
static int sensor_s_exp(struct v4l2_subdev *sd, unsigned int exp_val)
{
	...
	if (exp_val > (gc6153_sensor_vts - 16))
		exp_val = gc6153_sensor_vts - 16;
	if (exp_val < 16)
		exp_val = 16;
