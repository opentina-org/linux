...
/*
 * A V4L2 driver for Pattrne test.
 *
...
MODULE_AUTHOR("lhy");
MODULE_DESCRIPTION("A low-level driver for Pattrne test");
MODULE_LICENSE("GPL");
...
#define SENSOR_NAME "ptn_sensor"
#define SENSOR_NAME_2 "ptn2_sensor"
