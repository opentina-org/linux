...
static int sunxi_isp_subdev_init(struct v4l2_subdev *sd, u32 val)
{
	struct isp_dev *isp = v4l2_get_subdevdata(sd);
	struct vin_md *vind = dev_get_drvdata(isp->subdev.v4l2_dev->dev);
...
#if !defined CONFIG_ISP_SERVER_MELIS
static int sunxi_isp_subscribe_event(struct v4l2_subdev *sd,
				  struct v4l2_fh *fh,
...
static int __isp_init_subdev(struct isp_dev *isp)
{
