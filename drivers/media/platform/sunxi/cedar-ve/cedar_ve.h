...
#define VE_LOGK(fmt, arg...) pr_info("cedar-ve: " fmt, ##arg)
#define VE_LOGV(fmt, arg...)
#define VE_LOGD(fmt, arg...) pr_debug("cedar-ve: " fmt, ##arg)
#define VE_LOGI(fmt, arg...) pr_info("cedar-ve: " fmt, ##arg)
#define VE_LOGW(fmt, arg...) pr_warn("cedar-ve: " fmt, ##arg)
#define VE_LOGE(fmt, arg...) pr_err("cedar-ve: " fmt, ##arg)
